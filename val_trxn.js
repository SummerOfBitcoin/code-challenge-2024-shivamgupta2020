...
//                 allTransactions.splice(allTransactions.indexOf(transaction), 1);
//             }
//             else if (transaction.vin[0].prevout.scriptpubkey_type === "v0_p2wsh") {
//                 allTransactions.splice(allTransactions.indexOf(transaction), 1);
//             }
...
//     const address_created = createAddress_p2pkh(hexStrings[0]);
...
//     const address_created = createAddress_p2sh(hexStrings[0]);
//     if (match && req_scriptpubkey === str1 && address_created === address) {
//         return true; // Group 1 contains the public key hash
//     } else {
//         return false; // Return null if no match found
...
//                     console.log(input.prevout.scriptpubkey)
//                     allTransactions.splice(allTransactions.indexOf(transaction), 1);
//                     return;
//                 }
